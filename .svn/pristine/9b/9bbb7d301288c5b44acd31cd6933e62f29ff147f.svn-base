...
class model_user extends FeiModel{
	...
	public function acljump(){ 
		...
		echo "<html><head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\"><script>function sptips(){alert(\"对不起，您没有权限进行此操作！\");history.back();}</script></head><body onload=\"sptips()\"></body></html>";
		exit;
	}
}