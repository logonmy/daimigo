...
INSERT INTO `acl` VALUES('17','个人中心','FeiTm','profile','Fei_Admin');


INSERT INTO `acl` VALUES('18','修改密码','FeiTm','editpwd','Fei_Admin');


INSERT INTO `acl` VALUES('19','我的消息','FeiTm','message','Fei_Admin');


INSERT INTO `acl` VALUES('20','任务计划','project','task','Fei_Admin');


INSERT INTO `acl` VALUES('21','团队协作','cooperation','index','Fei_Admin');


INSERT INTO `acl` VALUES('22','团队成员','cooperation','person','Fei_Admin');


INSERT INTO `acl` VALUES('23','部门设置','cooperation','branch','Fei_Admin');


INSERT INTO `acl` VALUES('24','AJAX数据备份','setting','ajax_databack','Fei_Admin');


INSERT INTO `acl` VALUES('25','部门管理SET','cooperation','branch_set','Fei_Admin');
...
INSERT INTO `category` VALUES('3','0','电子公文','','','4','on','bug','icon-exclamation-sign','0000-00-00 00:00:00');
...
INSERT INTO `category` VALUES('27','6','快捷操作','','','2','on','shortcut','','0000-00-00 00:00:00');


INSERT INTO `category` VALUES('28','27','发现BUG','','','1','on','findbug','','0000-00-00 00:00:00');


INSERT INTO `category` VALUES('29','27','发布公告','','','2','on','issue','','0000-00-00 00:00:00');


INSERT INTO `category` VALUES('30','18','部门设置','','','3','on','branch','','0000-00-00 00:00:00');
...
INSERT INTO `system` VALUES('1','广的网络科技有限公司','技术部|产品部|编辑部|运营部|推广部|外联部|视频制作中心');
...
INSERT INTO `user` VALUES('2','xiong','1234567','熊寿长','技术部','PHP程序员','1');


INSERT INTO `user` VALUES('3','yuanyane','1234567','袁艳娥','技术部','前端工程师','1');
