<?php
/////////////////////////////////////////////////////////////////
// FeiPHP中文PHP框架, Copyright (C) 2008 - 2010 FeiPHP.com //
/////////////////////////////////////////////////////////////////
...
class FeiHtml
{
	...
	{
		if(1 == FeiAccess('r','Fei_html_making')){$this->Feiurls[] = array($Feiurl, $alias_url); return;}
	...
	public function start(){FeiAccess('w','Fei_html_making',1);$this->Feiurls = null;}
	public function commit(){FeiAccess('c','Fei_html_making');$this->makeAll($this->Feiurls);}
